...
* > 【青龙】拉取仓库命令：`ql repo https://github.com/moneyfly1/jd.git "jd_|jx_|getJDCookie"  "backUp|icon" "^jd[^_]|USER|sendNotify|sign_graphics_validate|JDJR|JDSign" "main"`
  * > 上面命令拉取错误的使用这个：`ql repo https://ghproxy.com/https://github.com/moneyfly1/jd.git "jd_|jx_|getJDCookie"  "backUp|icon" "^jd[^_]|USER|sendNotify|sign_graphics_validate|JDJR|JDSign" "main"`
...
* > [elecV2P](https://github.com/elecV2/elecV2P) 部署【随缘维护，建议转战➟[Docker](https://www.runoob.com/docker/windows-docker-install.html) [青龙](https://github.com/whyour/qinglong)】
    ...
    * 订阅任务：`https://ghproxy.com/https://github.com/moneyfly1/jd/main/jd_task.json`
